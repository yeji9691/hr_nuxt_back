...
public interface HrDetailCodeDAO {
	...
	public void deleteDetailCode(String deptCode);
	public void insertDetailCode(HrDetailCodeTO detailCodeto);
	
	public ArrayList<HrDetailCodeTO> selectPositionCodeList();
}